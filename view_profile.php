...
$doctors = [
    'Dr. Alexa_Cardiologist' => [
        ...
        'clinic_location' => 'Main Clinic: San Pablo City, Laguna',
...
<head>
  ...
  <title>Doctor Profile - <?php echo htmlspecialchars($doctor['name']); ?> - Medicare </title>
  ...
  <header class="bg-white shadow-lg sticky top-0 z-50 backdrop-blur-sm">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
      <div class="flex items-center space-x-3">
        <img src="Images/Logo.png" alt="Medicare" class="h-10 w-10">
